      ...
      faqs: [
        {
          ...
          answer: 'We use selfie verification technology combined with profile review. Members must provide a recent photo that matches their live selfie, and our team reviews profiles for authenticity.'
        },
        {
          question: 'What information is shared with other members?',
          answer: 'Only information you choose to share is visible to other members. You control your profile visibility, contact preferences, and what personal details you include. Your email and private information are never shared.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Yes, you can block any member from contacting you or seeing your profile. You can also remove connections at any time. Blocked users cannot rejoin groups you\'re in or attend events you organize.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: 'Use our interest matching feature - select from 48+ interests across categories like fitness, travel, career, and hobbies. We\'ll suggest connections based on shared interests and location.'
        },
        {
          question: 'How do I join or create events?',
          answer: 'Browse events in your area on the Events tab, or create your own with Core+ membership. Events range from coffee meetups to weekend trips, professional networking to hobby groups.'
        },
        {
          question: 'What types of groups can I join?',
          answer: 'We have interest-based groups (hiking, book clubs, career networking), location-based groups (London 30s, Manchester professionals), and activity groups (fitness, travel, food). All groups are moderated for safety.'
        },
        {
          question: 'How does messaging work?',
          answer: 'Free members can send 10 messages per month. Core members have unlimited messaging in groups and with connections. Premium members get priority message delivery and advanced messaging features.'
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: 'Go to your profile settings to update photos, interests, location, and bio. Changes to your profile photo require re-verification for safety. Other changes are instant.'
        },
        {
          question: 'Can I change my membership level?',
          answer: 'Yes, you can upgrade or downgrade anytime in account settings. Upgrades are immediate, downgrades take effect at the next billing cycle. Pro-rated refunds available for annual subscriptions.'
        },
        {
          question: 'How do I delete my account?',
          answer: 'Account deletion is permanent and removes all your data within 30 days. Go to Settings > Account > Delete Account. You can also request data export before deletion.'
        },
        {
          question: 'What happens if I cancel my subscription?',
          answer: 'You keep your current membership benefits until the end of your billing cycle, then your account reverts to free membership. Your profile and connections remain active.'
        }
      ]
    }
  ]
          ...
          <div className="container-width px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-center text-gray-500 mt-4">
                Popular searches: verification, pricing, events, safety, profile setup
              </p>
            </div>
          </div>
        </section>
                  ...
                  <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center text-gray-600">
                        ...
                        <a href={`mailto:${channel.contact}`} className={`text-${channel.color}-600 hover:underline font-medium`}>
                          {channel.contact}
                        </a>
                      </div>
                      <div className="flex items-center text-gray-600">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white border border-red-200 rounded-2xl p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Meeting Safely</h3>
                    <div className="space-y-3 text-gray-600">
                ...
                <div className="mt-6 p-4 bg-red-50 rounded-lg">
                  <p className="text-red-700 font-medium">
                    <strong>Remember:</strong> Your safety is our top priority. We have a zero-tolerance policy 
                    for harassment, threats, or any behavior that makes members feel unsafe. Report concerning 
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-shadow">
                  ...
                  <p className="text-gray-600 mb-4">
                    Learn about our community standards and how we maintain a safe, supportive environment.
                  </p>
                  <a href="/community" className="text-primary-600 hover:underline font-medium">
                    Read Guidelines →
                  </a>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Safety Center</h3>
                  <p className="text-gray-600 mb-4">
                    Comprehensive safety resources, tips, and tools to help you stay safe while making connections.
                  </p>
                  <a href="/safety" className="text-secondary-600 hover:underline font-medium">
                    Visit Safety Center →
                  </a>
                </div>
          ...
          <div className="container-width px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-sm opacity-75 mt-6">
                Average response time: 4-6 hours during business hours (Mon-Fri, 9am-6pm GMT)
              </p>
            </div>
          </div>
        </section>
